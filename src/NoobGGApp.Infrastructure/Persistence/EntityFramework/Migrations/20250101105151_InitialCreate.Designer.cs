...
namespace NoobGGApp.Infrastructure.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20250101105151_InitialCreate")]
            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 1, 1, 10, 51, 51, 358, DateTimeKind.Unspecified).AddTicks(6950), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.GameRegion", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 1, 1, 10, 51, 51, 359, DateTimeKind.Unspecified).AddTicks(1360), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
